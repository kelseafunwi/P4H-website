export const AppStoreButton = () => {
    return (
        <button
            className={"bg-dark text-white hover:opacity-65 flex items-center gap-x-2 columns-2 rounded-xl px-2 md:px-5 py-1"}>
            <span>
            ...
            <div className={"text-nowrap py-3 text-start"}>
                <p className={" font-normal uppercase text-[8px]"}>Download on the</p>
...
export const PlayStoreButton = () => {
    return (
        <button
            ...
            <div className={"text-nowrap py-3 text-start"}>
                <p className={"uppercase font-normal text-[8px]"}>Download on the</p>
                <p className={"font-bold text-white leading-3"}>Play Store</p>
            </div>
        </button>
    )
}
